...
export class EmailTemplateFactory {
    ...
    public static createInvitePlayerTemplate(toName: string, toEmail: string, inviteeForm: any): CallToActionEmailTemplate {

        const subject = `${config.app.name} - Golf Tournament Invitation`;
    ...
    public static createHelpSupportTemplete(needHelpForm: any,toName: string, toEmail: string): CallToActionEmailTemplate {
