...
import { HelpSupportJobProcessor } from "./jobs/help-support-job";
import { InvitePlayerJobProcessor } from "./jobs/invite-player-job";
...
export class Server {
    ...
    public async init() {
        ...
        const invitePlayerJobProcessor = new InvitePlayerJobProcessor(agendaJobDataExtractor, sendinblueEmailService);
        ...
        const helpSupportJobProcessor = new HelpSupportJobProcessor(agendaJobDataExtractor, sendinblueEmailService);
        ...
        this.agendaDependency.registerJobDefinitions(userEmailVerificationJob, userForgotPasswordRequestJob, tournamentResultJob,
            ...
            needHelpJobProcessor,helpSupportJobProcessor,invitePlayerJobProcessor);
        // Clean jobs
