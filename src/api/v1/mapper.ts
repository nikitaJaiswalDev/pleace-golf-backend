...
export class Mapper {
    ...
    public static mapTournamentScorecard(tournamentScorecard: TournamentScorecard): response.TournamentScorecardResponse {
        return {
    ...
    public static mapAllRoundScorecard(tournamentScorecards: TournamentScorecard[]): response.TournamentScorecardResponse[] {
    ...
    public static mapTournamentLeaderboardView(tournamentLeaderboard: any): response.TournamentLeaderboardResponse {
        return {
            ...
            clubCountryCode :  tournamentLeaderboard.courseId?.clubId?.countryCode,
