...
export class TournamentController {
    ...
    private initRoutes(): void {
        ...
        this.router.get("/:tournamentId/all-round-scorecard/:scorecardId/:userId", TournamentScorecardRequestSchema, validate, wrapAsyncWithErrorHandling(this.getAllRoundScorecard, this));
        this.router.post("/:tournamentId/scorecard/:scorecardId/:userId/:leaderboardId", SaveTournamentScorecardRequestSchema, validate, wrapAsyncWithErrorHandling(this.updateTournamentScorecard, this));
        ...
        this.router.post("/update-tournament", wrapAsyncWithErrorHandling(this.updateTournament, this));
        ...
        this.router.get("/play-next-round/:tournamentId/:userId",passport.authenticate("jwt", { session: false }), wrapAsyncWithErrorHandling(this.playNextRound, this));
    }
    ...
    public async getPlayerScorecard(req: Request, res: Response, next: NextFunction) {
        ...
        res.status(200).send(Mapper.mapTournamentScorecard(tournamentScorecard));
    }
     ...
     *              description: Server error
     */
     public async playNextRound(req: Request, res: Response, next: NextFunction) {
        const userId: string = req.params.userId;
       // const tournamentId = req.params.tournamentId;
        const tournamentId = req.params.tournamentId;
        const tournamentScorecard = await this.tournamentManagementService.playNextRound(userId, tournamentId);
        //Logger.debug(tournamentScorecard);
        //Logger.debug(tournamentScorecard.tee);
        //Logger.debug(tournamentScorecard.gender);
        res.status(200).send(Mapper.mapTournamentScorecard(tournamentScorecard));
     ...
     *              description: Server error
     */
     public async getAllRoundScorecard(req: Request, res: Response, next: NextFunction) {
        const userId: string = req.params.userId;
        const tournamentId = req.params.tournamentId;
        const scorecardId = req.params.scorecardId;
        const tournamentScorecards = await this.tournamentManagementService.getAllRoundScorecard(userId, scorecardId,tournamentId);
        res.status(200).send(Mapper.mapAllRoundScorecard(tournamentScorecards));
    }
    ...
    public async updateTournamentScorecard(req: Request, res: Response, next: NextFunction) {
        ...
        const tournamentScorecard = await this.tournamentManagementService.updateScorecard(userId, scorecardId, saveTournamentScorecardRequest.scores,leaderboardId);
