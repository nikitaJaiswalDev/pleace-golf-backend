...
import { validate, CheckUserIdInPathMatchJWT, validateEmail } from "../../../core/validation/validator";
...
export class UserController {
    ...
    constructor(userService: UserService, private authService: AuthenticationService) {
    ...
    private initRoutes(): void {
        ...
        this.router.get("/:userId", UserProfileRequestSchema, validate, wrapAsyncWithErrorHandling(this.getUserProfile, this));
        
        this.router.get("/email/:email", UserProfileRequestSchema, validateEmail,  wrapAsyncWithErrorHandling(this.getUserProfileByToken, this));
        
        this.router.get("/all/users", wrapAsyncWithErrorHandling(this.getUsers, this));
    ...
    */
    ...
    public async getUserProfileByToken(req: Request, res: Response, next: NextFunction) {
